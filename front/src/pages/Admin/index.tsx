    ...
    return (
        <Routes>
            <Route path="*" element={<MainLayout />}>
                <Route
                    path={"*"}
                    element={<Empty description={"Пустая страница"} />}
                />

                <Route
                    path={"shops"}
                    element={<Items storeType={StoreType.shop} />}
                />
                ...
                <Route
                    path={"events"}
                    element={<Items storeType={StoreType.event} />}
                />
                ...
                <Route
                    path={"discounts"}
                    element={<Items storeType={StoreType.discount} />}
                />
                ...
                <Route
                    path={"categories"}
                    element={<Items storeType={StoreType.category} />}
                />
                ...
                <Route
                    path={"images"}
                    element={<Items storeType={StoreType.image} />}
                />
