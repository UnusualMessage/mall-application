            ...
            <div className={classNames(css.content)}>
                <div className={classNames(css.info)}>
                    <InnerLink
                        ...
                        to={event.shop.routePath}
                    >
                        <Image
                            classes={classNames()}
                            source={event.shop.image.path}
                        />
                    </InnerLink>
